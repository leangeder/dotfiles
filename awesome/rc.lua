...
awful.util.tagnames = { "term", "web", "chat", "other", "5" }
...
globalkeys = awful.util.table.join(
    ...
    -- Perso screensaver
    -- awful.key({ modkey, "Control" }, "l", function() os.execute("/opt/i3lock-fancy/lock -p") end),
    awful.key({ modkey, "Control" }, "l", function() os.execute("i3lock -e -f -t -i ~/Images/screensaver.png") end),
    ...
    awful.key({}, "XF86AudioMute", function() awful.util.spawn("pactl -- set-sink-volume @DEFAULT_SINK@ toggle") end),
    awful.key({}, "XF86AudioPlay", function() awful.util.spawn("mpc toogle") end),
    awful.key({}, "XF86AudioPrev", function() awful.util.spawn("mpc -h $REMOTE_MPD_HOST prev") end),
    awful.key({}, "XF86AudioNext", function() awful.util.spawn("mpc -h $REMOTE_MPD_HOST next") end),
...
awful.rules.rules = {
    ...
    -- Set XTerm to always map on the first tag on screen 1.
    { rule = { class = "XTerm" },
      properties = { screen = 1, tag = screen[1].tags[1] } },

    -- Set Firefox/Chromium to always map on the second tag on screen 1.
    { rule = { class = "Firefox" },
    ...
    -- Set KeePassXC to always map on the three tag on screen 1/2.
